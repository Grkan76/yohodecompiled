...
.method private final getPurchaseLoggingParameters(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/facebook/appevents/iap/InAppPurchaseUtils$BillingClientVersion;)Ljava/util/List;
    ...
    .line 6
    new-instance v6, Lcom/facebook/appevents/OperationalData;

    invoke-direct {v6}, Lcom/facebook/appevents/OperationalData;-><init>()V
    ...
    const-string v9, "purchaseJSON.getString(Constants.GP_IAP_PRODUCT_ID)"
    ...
    .line 17
    const-string v11, "fb_iap_purchase_time"
    ...
    const-string v9, "purchaseJSON.getString(Constants.GP_IAP_PURCHASE_TIME)"
    ...
    const-string v9, "purchaseJSON.getString(Constants.GP_IAP_PURCHASE_TOKEN)"
    ...
    .line 23
    const-string v11, "fb_iap_package_name"
    ...
    const-string v9, "purchaseJSON.optString(Constants.GP_IAP_PACKAGE_NAME)"
    ...
    .line 26
    const-string v11, "fb_iap_product_title"
    ...
    const-string v9, "skuDetailsJSON.optString(Constants.GP_IAP_TITLE)"
    ...
    .line 29
    const-string v11, "fb_iap_product_description"
    ...
    const-string v9, "skuDetailsJSON.optString(Constants.GP_IAP_DESCRIPTION)"
    ...
    .line 50
    :try_start_1
    invoke-direct {v0, v15, v5, v6, v8}, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger;->getPurchaseParametersGPBLV5V7(Ljava/lang/String;Landroid/os/Bundle;Lcom/facebook/appevents/OperationalData;Lorg/json/JSONObject;)Ljava/util/List;
...
.method private final getPurchaseParametersGPBLV5V7(Ljava/lang/String;Landroid/os/Bundle;Lcom/facebook/appevents/OperationalData;Lorg/json/JSONObject;)Ljava/util/List;
    ...
    .line 8
    .line 9
    invoke-virtual {v4}, Lcom/facebook/appevents/iap/InAppPurchaseUtils$IAPProductType;->getType()Ljava/lang/String;
    ...
    .line 125
    const-string v13, "subscriptionJSON.optString(\n                        Constants.GP_IAP_BILLING_PERIOD\n                    )"
    ...
    .line 203
    invoke-direct {v7, v13, v14}, Ljava/math/BigDecimal;-><init>(D)V
    ...
    .line 214
    const-string v13, "getInstance(subscriptionJSON.getString(Constants.GP_IAP_PRICE_CURRENCY_CODE_V5V7))"
    ...
    .line 222
    .line 223
    invoke-direct {v6, v7, v2, v13, v14}, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;-><init>(Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;Lcom/facebook/appevents/OperationalData;)V
    ...
    .line 271
    const-string v5, "getInstance(oneTimePurchaseOfferDetailsJSON.getString(Constants.GP_IAP_PRICE_CURRENCY_CODE_V5V7))"
    ...
    .line 277
    .line 278
    invoke-direct {v4, v6, v1, v0, v5}, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;-><init>(Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;Lcom/facebook/appevents/OperationalData;)V

    .line 279
    .line 280
    .line 281
    new-array v0, v3, [Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;
