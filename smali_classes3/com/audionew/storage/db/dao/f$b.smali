.class Lcom/audionew/storage/db/dao/f$b;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/audionew/storage/db/dao/f;-><init>(Landroidx/room/RoomDatabase;)V
.end annotation
...
# instance fields
.field public final synthetic d:Lcom/audionew/storage/db/dao/f;


# direct methods
.method public constructor <init>(Lcom/audionew/storage/db/dao/f;Landroidx/room/RoomDatabase;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/audionew/storage/db/dao/f$b;->d:Lcom/audionew/storage/db/dao/f;
...
.method public e()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `messages` SET `MSG_ID` = ?,`CONV_ID` = ?,`FROM_ID` = ?,`FROM_NICK_NAME` = ?,`LAT` = ?,`LNG` = ?,`LEVEL` = ?,`PRIVACY` = ?,`DIRECTION` = ?,`CONTENT` = ?,`MSG_TYPE` = ?,`TALK_TYPE` = ?,`STATUS` = ?,`TIMESTAMP` = ?,`COOKIE` = ?,`SEQ` = ?,`LOCAL_ID` = ?,`EXTENSION_DATA` = ?,`MSG_BIZ_EXT` = ? WHERE `MSG_ID` = ?"
...
.method public bridge synthetic i(LS/k;Ljava/lang/Object;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Lcom/audionew/storage/db/dao/f$b;->k(LS/k;Lcom/audionew/storage/db/po/MessagePO;)V
...
.method public k(LS/k;Lcom/audionew/storage/db/po/MessagePO;)V
    .locals 4
    ...
    .line 77
    invoke-interface {p1, v1, v2, v3}, LS/i;->K(ID)V
