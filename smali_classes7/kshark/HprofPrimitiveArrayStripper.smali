...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "hprofSink",
        "",
        "(Lkshark/StreamingSourceProvider;Lokio/f;)V",
        "shark"
    }
    k = 0x1
    mv = {
...
.method public static synthetic stripPrimitiveArrays$default(Lkshark/HprofPrimitiveArrayStripper;Ljava/io/File;Ljava/io/File;ILjava/lang/Object;)Ljava/io/File;
    .locals 6
    ...
    .line 67
    :cond_1
    invoke-virtual {p0, p1, p2}, Lkshark/HprofPrimitiveArrayStripper;->stripPrimitiveArrays(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
...
.method public final stripPrimitiveArrays(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .line 3
    invoke-virtual {p0, v0, p1}, Lkshark/HprofPrimitiveArrayStripper;->stripPrimitiveArrays(Lkshark/StreamingSourceProvider;Lokio/f;)V

    return-object p2
.end method

.method public final stripPrimitiveArrays(Lkshark/StreamingSourceProvider;Lokio/f;)V
    .locals 11
    ...
    sget-object v3, Lkshark/StreamingHprofReader;->Companion:Lkshark/StreamingHprofReader$Companion;

    invoke-virtual {v3, p1, v1}, Lkshark/StreamingHprofReader$Companion;->readerFor(Lkshark/StreamingSourceProvider;Lkshark/HprofHeader;)Lkshark/StreamingHprofReader;

    move-result-object p1

    invoke-virtual {v0, p1}, Lkshark/StreamingRecordReaderAdapter$Companion;->asStreamingRecordReader(Lkshark/StreamingHprofReader;)Lkshark/StreamingRecordReaderAdapter;

    move-result-object p1

    .line 6
    sget-object v0, Lkshark/HprofWriter;->Companion:Lkshark/HprofWriter$Companion;

    .line 7
    new-instance v10, Lkshark/HprofHeader;

    .line 8
    invoke-virtual {v1}, Lkshark/HprofHeader;->getIdentifierByteSize()I

    move-result v7

    .line 9
    invoke-virtual {v1}, Lkshark/HprofHeader;->getVersion()Lkshark/HprofVersion;
    ...
    .line 10
    invoke-direct/range {v3 .. v9}, Lkshark/HprofHeader;-><init>(JLkshark/HprofVersion;IILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 11
    invoke-virtual {v0, p2, v10}, Lkshark/HprofWriter$Companion;->openWriterFor(Lokio/f;Lkshark/HprofHeader;)Lkshark/HprofWriter;
    ...
    .line 13
    new-instance v1, Lkshark/HprofPrimitiveArrayStripper$stripPrimitiveArrays$2$1;

    invoke-direct {v1, p2}, Lkshark/HprofPrimitiveArrayStripper$stripPrimitiveArrays$2$1;-><init>(Lkshark/HprofWriter;)V

    .line 14
    invoke-virtual {p1, v0, v1}, Lkshark/StreamingRecordReaderAdapter;->readRecords(Ljava/util/Set;Lkshark/OnHprofRecordListener;)J
    :try_end_1
