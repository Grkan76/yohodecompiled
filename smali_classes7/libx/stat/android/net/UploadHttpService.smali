.class public final Llibx/stat/android/net/UploadHttpService;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Llibx/stat/android/net/UploadHttpService;",
...
# static fields
.field public static final INSTANCE:Llibx/stat/android/net/UploadHttpService;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Llibx/stat/android/net/UploadHttpService;

    .line 2
    .line 3
    invoke-direct {v0}, Llibx/stat/android/net/UploadHttpService;-><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Llibx/stat/android/net/UploadHttpService;->INSTANCE:Llibx/stat/android/net/UploadHttpService;
    ...
    .line 16
    .line 17
    sput-object v0, Llibx/stat/android/net/UploadHttpService;->bizExecutor:Ljava/util/concurrent/Executor;
...
.method private final normalHttpClient()Lokhttp3/OkHttpClient;
    ...
    .line 26
    const-string v1, "okHttpClientBuilder.build()"
...
.method public buildRetrofit()Lretrofit2/A;
    ...
    .line 1
    invoke-direct {p0}, Llibx/stat/android/net/UploadHttpService;->normalHttpClient()Lokhttp3/OkHttpClient;
    ...
    .line 5
    sget-object v1, Llibx/stat/android/net/UploadHttpService;->bizExecutor:Ljava/util/concurrent/Executor;
    ...
    .line 21
    const-string v1, "buildRetrofitBase(\n     \u2026llectHost()\n    ).build()"
...
.method public final collectBizRequest(Lretrofit2/d;Lkotlin/jvm/functions/Function1;)V
    ...
    .line 21
    new-instance v8, Llibx/stat/android/net/UploadHttpService$collectBizRequest$$inlined$okHttpCall$1;
    ...
    .line 24
    const-class v4, Llibx/stat/android/net/UploadApi;
    ...
    .line 29
    invoke-direct/range {v1 .. v6}, Llibx/stat/android/net/UploadHttpService$collectBizRequest$$inlined$okHttpCall$1;-><init>(Lretrofit2/A;Lkotlin/jvm/functions/Function1;Ljava/lang/Class;Lretrofit2/d;Lkotlin/coroutines/e;)V
