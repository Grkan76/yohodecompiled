...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v3, v1, v1, v2}, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    const-string v4, "OAuth request to Snapchat failed due to authorization error. Please check to ensure your application is using the correct \'OAuth 2.0 Client ID\' and has followed all the set up instructions correctly. If testing on the STAGING environment ensure that the Snapchat username for whom you\u2019re trying to test this feature is in the list of Demo Users on the Snap Kit Developer Portal."

    const-string v5, "AUTHORIZATION_FAILURE"

    invoke-direct {v2, v5, v3, v3, v4}, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v2, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;->AUTHORIZATION_FAILURE:Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;

    new-instance v4, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;

    const/4 v5, 0x2

    const-string v6, "OAuth request to Snapchat failed during the Custom Token cloud function fetch. Please check to ensure your application is using the correct \'Confidential OAuth 2.0 Client ID\' and has followed all the set up instructions correctly."

    const-string v7, "CUSTOM_TOKEN_FETCH_FAILURE"

    invoke-direct {v4, v7, v5, v5, v6}, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v4, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;->CUSTOM_TOKEN_FETCH_FAILURE:Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;

    const/4 v6, 0x3

    new-array v6, v6, [Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;
    ...
    sput-object v6, Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;->$VALUES:[Lcom/snap/loginkit/exceptions/FirebaseCustomTokenException$Status;
