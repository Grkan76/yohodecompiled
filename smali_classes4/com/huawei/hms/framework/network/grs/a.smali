...
.method public a(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string v14, "GrsClientManager.synGetGrsUrl: Return [%s][%s] Url: %s"
...
.method public a(Ljava/lang/String;Landroid/content/Context;I)Ljava/util/Map;
    ...
    const-string v4, "The serviceName[%s] is not configured on the GRS server."

    invoke-static {p3, v4, v3}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :cond_2
    sget-object p3, Lcom/huawei/hms/framework/network/grs/a;->e:Ljava/lang/String;

    const-string v3, "GrsClientManager.synGetGrsUrls: Get URL from Local JSON File."

    invoke-static {p3, v3}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    const-string v3, "The serviceName[%s] is not configured in the JSON configuration files to reveal all the details"

    invoke-static {p3, v3, p2}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/IQueryUrlsCallBack;Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, v3, v5}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/b;Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-static {v3, v1, v2}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v1, -0x5

    invoke-interface {p2, v1}, Lcom/huawei/hms/framework/network/grs/IQueryUrlsCallBack;->onCallBackFail(I)V
    ...
    const-string v5, "GrsClientManager.ayncGetGrsUrls\uff1aReturn [%s] Urls: %s"

    invoke-static {v3, v5, v7}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v1, "ayncGetGrsUrls: %s"

    invoke-static {v3, v1, v2}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {p2, v6}, Lcom/huawei/hms/framework/network/grs/IQueryUrlsCallBack;->onCallBackSuccess(Ljava/util/Map;)V

    :goto_0
    return-void

    :cond_1
    new-instance v9, Lcom/huawei/hms/framework/network/grs/g/j/c;

    iget-object v1, v0, Lcom/huawei/hms/framework/network/grs/a;->a:Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;

    invoke-direct {v9, v1, v5}, Lcom/huawei/hms/framework/network/grs/g/j/c;-><init>(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Landroid/content/Context;)V

    iget-object v10, v0, Lcom/huawei/hms/framework/network/grs/a;->c:Lcom/huawei/hms/framework/network/grs/g/g;

    new-instance v11, Lcom/huawei/hms/framework/network/grs/a$a;

    iget-object v7, v0, Lcom/huawei/hms/framework/network/grs/a;->a:Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;

    iget-object v12, v0, Lcom/huawei/hms/framework/network/grs/a;->b:Lcom/huawei/hms/framework/network/grs/e/a;
