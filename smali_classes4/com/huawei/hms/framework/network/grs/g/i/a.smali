...
.method public static declared-synchronized a(Landroid/content/Context;)Lcom/huawei/hms/framework/network/grs/g/j/d;
    ...
    const-class v2, Lcom/huawei/hms/framework/network/grs/g/i/a;

    monitor-enter v2

    :try_start_0
    sget-object v3, Lcom/huawei/hms/framework/network/grs/g/i/a;->c:Ljava/lang/Object;
    ...
    const-string v5, "grs_sdk_server_config.json"
    ...
    invoke-static {v4, p0}, Lcom/huawei/hms/framework/network/grs/h/c;->a(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Lcom/huawei/hms/framework/network/grs/g/j/d;->a(Ljava/util/List;)V

    const-string v4, "grs_query_endpoint_2.0"

    invoke-virtual {p0, v4}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    sget-object v5, Lcom/huawei/hms/framework/network/grs/g/i/a;->b:Lcom/huawei/hms/framework/network/grs/g/j/d;

    invoke-virtual {v5, v4}, Lcom/huawei/hms/framework/network/grs/g/j/d;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, p0}, Lcom/huawei/hms/framework/network/grs/g/j/d;->a(I)V
    :try_end_3
    ...
    :goto_1
    :try_start_4
    sget-object v4, Lcom/huawei/hms/framework/network/grs/g/i/a;->a:Ljava/lang/String;
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    :try_start_5
    const-string v5, "getGrsServerBean catch JSONException: %s"
    :try_end_5
    ...
    invoke-static {v4, v5, v0}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
