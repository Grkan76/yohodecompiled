...
.method public static b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
    ...
    .line 3
    .line 4
    invoke-static {p0, v0}, Ld5/f;->f(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    .line 8
    invoke-static {p0, p1}, Ld5/f;->a(Landroid/net/Uri$Builder;Ljava/util/Map;)Landroid/net/Uri$Builder;
...
.method public static c(Ljava/lang/String;Ljava/util/Map;)Landroid/net/Uri;
    ...
    .line 5
    invoke-static {p0, p1}, Ld5/f;->b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
...
.method public static varargs e(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 1
    invoke-static {p0, p1}, Ld5/f;->f(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri$Builder;
