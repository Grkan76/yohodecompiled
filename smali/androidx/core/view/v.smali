...
.method public constructor <init>(Landroidx/core/graphics/b;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/core/graphics/b;)V
    ...
    .param p1    # Landroidx/core/graphics/b;
        ...
        .end annotation
    .end param
    .param p6    # Landroidx/core/graphics/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 2
    invoke-static/range {v0 .. v6}, Landroidx/core/view/v;->a(Landroidx/core/graphics/b;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/core/graphics/b;Landroid/graphics/Path;)Landroid/view/DisplayCutout;
...
.method public constructor <init>(Landroidx/core/graphics/b;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/core/graphics/b;Landroid/graphics/Path;)V
    .locals 0
    .param p1    # Landroidx/core/graphics/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    invoke-static/range {p1 .. p7}, Landroidx/core/view/v;->a(Landroidx/core/graphics/b;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/core/graphics/b;Landroid/graphics/Path;)Landroid/view/DisplayCutout;
...
.method public static a(Landroidx/core/graphics/b;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/core/graphics/b;Landroid/graphics/Path;)Landroid/view/DisplayCutout;
    .locals 9
    ...
    .line 20
    invoke-static/range {v2 .. v8}, Landroidx/core/view/v$d;->a(Landroid/graphics/Insets;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Insets;Landroid/graphics/Path;)Landroid/view/DisplayCutout;
    ...
    .line 41
    invoke-static/range {v1 .. v6}, Landroidx/core/view/v$c;->a(Landroid/graphics/Insets;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Insets;)Landroid/view/DisplayCutout;
    ...
    .line 64
    .line 65
    iget p6, p0, Landroidx/core/graphics/b;->a:I
...
.method public static f(Landroid/view/DisplayCutout;)Landroidx/core/view/v;
    .locals 1
...
.method public b()I
    ...
    .line 8
    .line 9
    invoke-static {v0}, Landroidx/core/view/v$a;->b(Landroid/view/DisplayCutout;)I
